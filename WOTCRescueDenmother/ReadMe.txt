...
[*] Lore entry in XCOM Archives.[/list]
...
Rookies [i][b]will not[/b][/i] be randomly promoted to the Keeper class. To be able to train Rookies to Keepers in GTS, you have to promote a Keeper (so, Denmother) to a Captain and then purchase an unlock in GTS for 50 Supplies. Doing so will also grant [b]Steady Aim[/b] perk to all Keepers. 
...
Cosmetics by [b]Kexx[/b].
Class icon by [b]NeIVIeSiS[/b].
Keeper class description by [b]lago502[/b]
